...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <span class="text-primary">{{__('dashboard.Update_Listing')}} : </span>
            </h1>
                          ...
                          <div class="row">
                            <div class="col-md-4">
                                <div class="form-group my-5">
                                    ...
                                    <input type="text" class="form-control" id="l_ref" name="l_ref" value="{{$listing->ref}}">
                           ...
                           <div class="row">
                            <div class="col-md-12">
                                <div class="form-group my-5">
                                    ...
                                    <textarea class="form-control" id="map" name="map" cols="30" rows="5" >{{$listing->map}}</textarea>
                                </div>
                            </div>
                          </div>
                          <!-- end map -->
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <input id="en_title" type="hidden" name="en_title" value="{!!$listing->en_title!!}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <input id="fr_title" type="hidden" name="fr_title" value="{!!$listing->fr_title!!}" />
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <input id="es_title" type="hidden" name="es_title" value="{{$listing->es_title}}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <input id="ar_title" type="hidden" name="ar_title" value="{{$listing->ar_title}}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="l_category" id="l_category">
                                        ...
                                        <option selected value="{{$listing->category->id}}"> {{$listing->category->en_title}} </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="l_city" id="l_city">
                                        ...
                                        <option selected value="{{$listing->city->id}}"> {{$listing->city->en_city}} </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="l_area" id="l_area">
                                        ...
                                        <option selected value="{{$listing->area->id}}"> {{$listing->area->en_area}} </option>
                           ...
                           <div class="row">
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="l_type" id="l_type">
                                      ...
                                      <option selected value="{{$listing->type_listing}}">{{$listing->type_listing}}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <input type="text" class="form-control" id="l_price" name="l_price" value="{{$listing->price}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    <label class="text-success" for="l_space">{{__('dashboard.Listing_Space')}} :</label>
                                    <input type="text" class="form-control" id="l_space" name="l_space" value="{{$listing->space}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="measure" id="measure">
                                        ...
                                        <option selected value="{{$listing->measure}}">{{$listing->measure}}</option>
                           ...
                           <div class="row">
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <input type="text" class="form-control" id="nbr_rooms" name="nbr_rooms" value="{{$listing->nbr_rooms}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    <label class="text-success" for="nbr_living_romm">{{__('dashboard.Number_of_Living_Room ')}}:</label>
                                    <input type="text" class="form-control" id="nbr_living_romm" name="nbr_living_romm" value="{{$listing->nbr_living_romm}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    <label class="text-success" for="nbr_bathroom">{{__('dashboard.Number_of_Bathrooms ')}} :</label>
                                    <input type="text" class="form-control" id="nbr_bathroom" name="nbr_bathroom" value="{{$listing->nbr_bathroom}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    <label class="text-success" for="nbr_bedrooms">{{__('dashboard.Number_of_Bedrooms ')}} :</label>
                                    <input type="text" class="form-control" id="nbr_bedrooms" name="nbr_bedrooms" value="{{$listing->nbr_bedrooms}}">
                                </div>
                            </div>
                          </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="balcony" id="balcony">
                                        ...
                                        <option selected value="{{$listing->balcony}}">{{$listing->balcony}}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="terrace" id="terrace">
                                        <option><span class="text-success">select shoes</span></option>
                                        <option selected value="{{$listing->terrace}}">{{$listing->terrace}}</option>
                                        <option value="yes"> yes </option>
                                        <option value="none"> none </option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="view" id="view">
                                        ...
                                        <option selected value="{{$listing->view}}">{{$listing->view}}</option>
                                       <option value="yes"> yes </option>
                                       <option value="none"> none </option>
                                     </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="garden" id="garden">
                                        ...
                                        <option selected value="{{$listing->garden}}">{{$listing->garden}}</option>
                                        <option value="yes"> yes </option>
                                        <option value="none"> none </option>
                                     </select>
                                </div>
                         ...
                         <div class="row">
                            <div class="col-md-4">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="garage" id="garage">
                                        <option><span class="text-success">select shoes</span></option>
                                        <option selected value="{{$listing->garage}}">{{$listing->garage}}</option>
                                       <option value="yes"> yes </option>
                                       <option value="none"> none </option>
                                     </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="parking" id="parking">
                                        <option><span class="text-success">select shoes</span></option>
                                        <option selected value="{{$listing->parking}}">{{$listing->parking}}</option>
                                        <option value="yes"> yes </option>
                                        <option value="none"> none </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group my-5">
                                    ...
                                    <select class="form-control" name="swimming_pool" id="swimming_pool">
                                        <option><span class="text-success">select shoes</span></option>
                                        <option selected value="{{$listing->swimming_pool}}">{{$listing->swimming_pool}}</option>
                                       <option value="yes"> yes </option>
                                       <option value="none"> none </option>
                                     </select>
                                </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <textarea name="en_desc" class="form-control" id="editor" cols="30" rows="10">{{ $listing->en_desc }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    <label class="text-success" for="fr_desc">{{__('dashboard.fr_desc')}} :</label>
                                    <textarea name="fr_desc" class="form-control" id="fr_desc" cols="30" rows="10">{{ $listing->fr_desc }}</textarea>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <textarea name="es_desc" class="form-control" id="es_desc" cols="30" rows="10">{{ $listing->es_desc }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    <label class="text-success" for="ar_desc">{{__('dashboard.ar_desc')}} :</label>
                                    <textarea dir="rtl" name="ar_desc" class="form-control" id="ar_desc" cols="30" rows="10">{{ $listing->ar_desc }}</textarea>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <textarea name="en_more_info" class="form-control" id="en_more_info" cols="30" rows="10">{{ $listing->en_more_info }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    <label class="text-success" for="fr_more_info">{{__('dashboard.fr_more_info')}} :</label>
                                    <textarea name="fr_more_info" class="form-control" id="fr_more_info" cols="30" rows="10">{{ $listing->fr_more_info }}</textarea>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <textarea name="es_more_info" class="form-control" id="es_more_info" cols="30" rows="10">{{ $listing->es_more_info }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    <label class="text-success" for="ar_more_info">{{__('dashboard.ar_more_info')}} :</label>
                                    <textarea dir="rtl" name="ar_more_info" class="form-control" id="ar_more_info" cols="30" rows="10">{{ $listing->ar_more_info }}</textarea>
                                </div>
                            </div>
                          </div>
                          <!-- end start listing es_desc and ar_desc -->
                          ...
                          <div class="form-group my-5">
                              ...
                              <div class="form-group">
                                <h4 class="text-success">{{__('dashboard.Current_Image')}} :</h4>
                                    <div class="row text-center">

                                        @foreach (json_decode($listing->images) as $img)
                                            <span class="text-center"> <img style="width: 200px;height: 150px;" src="{{asset('public/'.$img)}}" alt=""> </span>
                                        @endforeach
                                    </div>
                          ...
                          <div class="form-group my-5">
                              <input type="submit" class="btn btn-success btn-block" value="{{__('dashboard.Update_Listing')}}">
                          </div>
                      </form>
                </div>
