<aside class="main-sidebar">
        ...
        <section style="margin-left: 5px;" class="sidebar">
            ...
            <ul style="margin-left: 10px" class="sidebar-menu">
                ...
                <li class="active"><a href="{{ route('dashboard') }}"><i style="font-size: 2rem;margin-right: 10px" class="fas fa-home text-primary"></i> <span>{{__('dashboard.DASHBOARD')}}</span></a></li>
                ...
                <li class="active"><a href="{{route('dashboard.permessions')}}"><i style="color: goldenrod;font-size: 2rem;margin-right: 10px" class="fas fa-user-shield"></i> <span>{{__('dashboard.PERMESSIONS')}}</span></a></li>
                ...
                <li class="active"><a href="{{ route('dashboard.users_profiles') }}"><i style="font-size: 2rem;margin-right: 10px" class="fas fa-user text-primary"></i> <span>{{Auth::user()->profile->username}}</span></a></li>

                @else

                <li class="active"><a href="{{ route('dashboard.users_profiles') }}"><i style="font-size: 2rem;margin-right: 10px" class="fas fa-user text-primary"></i> <span>{{__('dashboard.ALL_USERS')}}</span></a></li>
                @endif
                ...
                <li class="treeview">
                    <a href="#">{{-- <i class="fa fa-link"></i> --}}
                        <img style="font-size: 2rem;margin-right: 10px" width="30px" height="30px" src="{{asset('public/assets-file/images/category.png')}}" alt="category">
                ...
                <li class="treeview">
                    <a href="#"> {{-- <i class="fa fa-link"></i> --}}
                        <img style="font-size: 2rem;margin-right: 10px" width="30px" height="30px" src="{{asset('public/assets-file/images/category.png')}}" alt="cities">
                ...
                <li class="treeview">
                    <a href="#"> {{-- <i class="fa fa-link"></i> --}}
                        <img style="font-size: 2rem;margin-right: 10px" width="30px" height="30px" src="{{asset('public/assets-file/images/category.png')}}" alt="areas">
                ...
                <li class="treeview">
                    <a href="#"> {{-- <i class="fa fa-link"></i> --}}
                        <img style="font-size: 2rem;margin-right: 10px" width="30px" height="30px" src="{{asset('public/assets-file/images/category.png')}}" alt="listings">
                ...
                <li class="active"><a href="{{ route('contact.index') }}"><i style="font-size: 2rem;margin-right: 10px" class="fas fa-address-card text-primary"></i> <span>{{__('dashboard.CONTACTS')}}</span></a></li>
