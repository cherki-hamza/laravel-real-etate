        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xl-5">
                <div class="about_thumb">
                    <img class="img-fluid w100" src="{{asset('public/frontend/frontend-assets/images/about/1.jpg')}}" alt="1.jpg">
                ...
                <div class="testimonial_grid_slider style2">
                    <div class="item">
                        <div class="testimonial_grid style2">
                            <div class="thumb">
                                <img src="{{asset('public/frontend/frontend-assets/images/testimonial/1.jpg')}}" alt="1.jpg">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="{{asset('public/frontend/frontend-assets/images/partners/1.png')}}" alt="1.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="{{asset('public/frontend/frontend-assets/images/partners/2.png')}}" alt="2.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="{{asset('public/frontend/frontend-assets/images/partners/3.png')}}" alt="3.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="{{asset('public/frontend/frontend-assets/images/partners/4.png')}}" alt="4.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="{{asset('public/frontend/frontend-assets/images/partners/5.png')}}" alt="5.png">
                </div>
            </div>
        </div>
    </div>
