    ...
    <div class="container-fluid p0">
        ...
        <nav>
            ...
            <div class="menu-toggle">
                <img class="nav_logo_img img-fluid" src="{{asset('public/frontend/frontend-assets/images/header-logo.png')}}" alt="header-logo.png">
            ...
            <a href="#" class="navbar_brand float-left dn-smd">
                <img class="logo1 img-fluid" src="{{asset('public/frontend/frontend-assets/images/header-logo2.png')}}" alt="header-logo.png">
            ...
            <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
                ...
                <li class="list-inline-item"><a href="{{route('site.home')}}"><span class="title text-dark">Home</span></a></li>
                <li class="list-inline-item"><a href="{{route('site.about')}}"><span class="title text-dark">About</span></a></li>
                <li class="list-inline-item"><a href="{{route('site.listings')}}"><span class="title text-dark">Listings</span></a></li>
                <li class="list-inline-item"><a href="{{route('site.sell')}}"><span class="title text-dark">To Sell</span></a></li>
                <li class="list-inline-item"><a href="{{route('site.rent')}}"><span class="title text-dark">To Rent</span></a></li>

                <li class="last">
                    <a href="{{route('site.contact')}}"><span class="title"><span class="title text-dark">Contact</span></span></a>
                </li>

                 <!-- start langs -->

                 <li class="">
                    <a href="#"><span class="title text-dark">Langues</span></span></a>
                    <!-- Level Two-->
