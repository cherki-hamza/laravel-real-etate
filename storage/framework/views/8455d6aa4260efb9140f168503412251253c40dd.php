        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xl-5">
                <div class="about_thumb">
                    <img class="img-fluid w100" src="<?php echo e(asset('public/frontend/frontend-assets/images/about/1.jpg')); ?>" alt="1.jpg">
                    <a class="popup-iframe popup-youtube color-white" href="https://www.youtube.com/"><i class="flaticon-play"></i></a>
                </div>
            </div>
        </div>
        <div class="row mt50">
                ...
                <div class="team_slider">
                    <div class="item">
                        <div class="team_member">
                            <div class="thumb">
                                <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/team/1.jpg')); ?>" alt="1.jpg">
                                <div class="overylay">
                    ...
                    <div class="item">
                        <div class="team_member">
                            <div class="thumb">
                                <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/team/2.jpg')); ?>" alt="2.jpg">
                                <div class="overylay">
                                    <ul class="social_icon">
                                        <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
                    ...
                    <div class="item">
                        <div class="team_member">
                            <div class="thumb">
                                <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/team/3.jpg')); ?>" alt="3.jpg">
                                <div class="overylay">
                                    <ul class="social_icon">
                                        <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
                    ...
                    <div class="item">
                        <div class="team_member">
                            <div class="thumb">
                                <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/team/4.jpg')); ?>" alt="4.jpg">
                                <div class="overylay">
                                    <ul class="social_icon">
                                        <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="testimonial_grid_slider style2">
                    <div class="item">
                        <div class="testimonial_grid style2">
                            <div class="thumb">
                                <img src="<?php echo e(asset('public/frontend/frontend-assets/images/testimonial/1.jpg')); ?>" alt="1.jpg">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/partners/1.png')); ?>" alt="1.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/partners/2.png')); ?>" alt="2.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/partners/3.png')); ?>" alt="3.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/partners/4.png')); ?>" alt="4.png">
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg">
                <div class="our_partner">
                    <img class="img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/partners/5.png')); ?>" alt="5.png">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('frontend.master.app-site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cherki-RealEstate/resources/views/frontend/site/pages/about.blade.php ENDPATH**/ ?>