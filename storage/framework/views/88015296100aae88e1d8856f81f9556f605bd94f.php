<?php $__env->startSection('title' , 'Add New Listing'); ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-5">
                                    ...
                                    <input dir="rtl" id="ar_title" type="hidden" name="ar_title" value="" />
...
<?php echo $__env->make('backend.master.app-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-2021/cherki-RealEstate/resources/views/backend/dashboard/real-estate/listings/create.blade.php ENDPATH**/ ?>