...
<head>
    ...
    <title><?php echo e(config('app.name', 'Cherki Real Estate')); ?></title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img style="width: 150px;height: 60px;" src="<?php echo e(asset('public/assets-file/images/logo-ams-immo.jpg')); ?>" alt="">
                </a>
...
<?php /**PATH /var/www/html/cherki-RealEstate/resources/views/layouts/app.blade.php ENDPATH**/ ?>