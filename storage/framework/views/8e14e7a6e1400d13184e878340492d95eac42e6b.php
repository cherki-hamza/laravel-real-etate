...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <span class="text-primary"><?php echo e(__('dashboard.Update_Category')); ?> : </span>
            </h1>
                  ...
                  <div class="box-header">
                   ...
                   <span>    <?php echo $__env->make('backend.alert.alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> </span>
                      ...
                      <h3 class="text-primary">
                        <?php echo e(__('dashboard.Update_Category')); ?>
                  ...
                  <div class="box-body">
                      <form action="<?php echo e(route('categories.update',$category->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-5">
                          ...
                          <div class="form-group my-5">
                              <input type="submit" class="btn btn-success btn-block" value="<?php echo e(__('dashboard.Update_Category')); ?>">
                          </div>
                      </form>
                </div>
