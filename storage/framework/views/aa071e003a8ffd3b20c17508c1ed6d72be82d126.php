            ...
            <div class="col-xl-6">
                <div class="breadcrumb_content">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('site.home')); ?>">Contact</a></li>
                    </ol>
            ...
            <div class="col-lg-7 col-xl-8">
                <div class="form_grid">
                   ...
                   <!-- end alert -->
                    ...
                    <form class="contact_form"  action="<?php echo e(route('site.contact.store')); ?>" method="POST" >
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
...
<?php echo $__env->make('frontend.master.app-site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cherki-RealEstate/resources/views/frontend/site/pages/contact.blade.php ENDPATH**/ ?>