    ...
    <div class="container-fluid p0">
        ...
        <nav>
            ...
            <div class="menu-toggle">
                <img class="nav_logo_img img-fluid" src="<?php echo e(asset('public/frontend/frontend-assets/images/header-logo2.png')); ?>" alt="header-logo.png">
            ...
            <a href="#" class="navbar_brand float-left dn-smd">
                <img style="width: 100px" height="46px" class="logo1 img-fluid" src="<?php echo e(asset('public/assets-file/images/logo-ams-immo.jpg')); ?>" alt="amsimmo">
            ...
            <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
                ...
                <li class="list-inline-item"><a href="<?php echo e(route('site.home')); ?>"><span class="title">Home</span></a></li>
                <li class="list-inline-item"><a href="<?php echo e(route('site.about')); ?>"><span class="title">About</span></a></li>
                <li class="list-inline-item"><a href="<?php echo e(route('site.listings')); ?>"><span class="title">Listings</span></a></li>
                <li class="list-inline-item"><a href="<?php echo e(route('site.sell')); ?>"><span class="title">To Sell</span></a></li>
                <li class="list-inline-item"><a href="<?php echo e(route('site.rent')); ?>"><span class="title">To Rent</span></a></li>
    ...
    <div class="mobile-menu">
        <div class="header stylehome1">
            <div class="main_logo_home2 text-center">
                <img style="width: 70px" height="46px" class="nav_logo_img img-fluid mt20" src="<?php echo e(asset('public/assets-file/images/logo-ams-immo.jpg')); ?>" alt="amsimmo">
...
<?php /**PATH /var/www/html/cherki-RealEstate/resources/views/frontend/layouts/menu-home.blade.php ENDPATH**/ ?>