...
class AreasController extends Controller
{
    ...
    public function create()
    {
        ...
        if($cities->count() == 0){
            return redirect()->route('cities.create')->with('warning' , 'Oops you have first add the new city');
        }
        return view('backend.dashboard.real-estate.areas.create' , ['areas'=>$areas , 'cities'=>$cities]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('picture')){
         ...
         // default no picture
          $picture = 'assets-file/images/no_image.png';
    ...
    public function edit($id)
    {
        ...
        return view('backend.dashboard.real-estate.areas.edit' , ['area'=>$area ,'cities'=>$cities]);
    }
