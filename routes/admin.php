...
Route::group(
    [
       ...
       Route::resource('/admin/contact', 'backend\ContactController');
      ...
      // Route::delete('/admin/delete_profile/{id}' , 'backend\DashboardController@delete_profile')->name('dashboard.delete_profile');
       ...
       // routes for cities listening
       // this is a resource route for crud city
       Route::resource('/admin/cities' , 'backend\CitiesController' );

       // routes for areas listening
       // this is a resource route for crud area
       Route::resource('/admin/areas' , 'backend\AreasController' );


       // routes for  listening real estate
       // this is a resource route for crud listening real estate
       Route::resource('/admin/listings' , 'backend\ListingsController' );



       // route for upload ckeditor file
       Route::post('/admin/upload' , 'backend\ListingsController@upload')->name('upload');
